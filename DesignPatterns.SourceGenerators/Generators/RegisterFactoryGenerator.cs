...
public sealed class RegisterFactoryGenerator : IIncrementalGenerator
{
    ...
    private static void ReportDuplicateKeys(SourceProductionContext context, List<FactoryRegistration> registrations)
    {
    ...
    private static void ReportContractMismatches(SourceProductionContext context, List<FactoryRegistration> registrations)
    {
    ...
    private static void ReportMissingConstructors(SourceProductionContext context, List<FactoryRegistration> registrations)
    {
