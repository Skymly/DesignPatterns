...
| `DesignPatterns.Extensions.AppSettings/` | AppSettings → strategy registry 桥接 |
...
| AppSettings 扩展 | `tests/DesignPatterns.Extensions.AppSettings.Tests`（net8.0）、`tests/DesignPatterns.Extensions.AppSettings.Tests.Net48`（net48 编译） | AppSettings 桥接 |
