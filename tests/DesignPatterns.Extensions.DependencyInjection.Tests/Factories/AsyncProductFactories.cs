...
namespace DesignPatterns.Extensions.DependencyInjection.Tests.Factories;
...
public sealed class StandardPooledProductFactory : IPooledProductFactory, IAsyncFactory<IPooledProductFactory>, IResettable
{
