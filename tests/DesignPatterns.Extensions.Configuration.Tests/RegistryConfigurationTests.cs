...
public sealed class RegistryConfigurationTests : IClassFixture<AppSettingsFixture>
{
    ...
    [Fact]
    public void ResolveConfigured_IConfiguration_ReturnsImplementation_ForValidConfigurationKey()
    {
        var registry = CreateRegistry();
    ...
    [Fact]
    public void TryResolveConfigured_IConfiguration_ReturnsFalse_WhenConfigurationKeyIsMissing()
    {
        var registry = CreateRegistry();
    ...
    [Fact]
    public void ResolveConfigured_IConfiguration_Throws_WhenConfigurationValueIsUnknown()
    {
        var registry = CreateRegistry();
    ...
    [Fact]
    public void TryResolveConfigured_IConfiguration_UsesDefaultKey_WhenConfigurationKeyIsMissing()
    {
        var registry = CreateRegistry();
    ...
    [Fact]
    public void ResolveConfigured_IConfiguration_UsesDefaultKey_WhenConfigurationValueIsEmpty()
    {
        var registry = CreateRegistry();
